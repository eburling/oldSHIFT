...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--coordconv', type=bool, default=False, help='adds coordconv layer to input')
        self.parser.add_argument('--loadSize', type=int, default=286, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')
        self.parser.add_argument('--stain_channel', type=int, default=0, help='red:0, green:1, blue:2')        
    ...
    def parse(self):
        ...
        file_name = os.path.join(expr_dir, f'{self.opt.phase}_opt.txt')
